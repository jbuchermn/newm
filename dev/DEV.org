...
* Current (v0.2)
** STRT View state handling rewrite
- [ ] One reducer for all views (everything inside state)
- [ ] Seperate class to handle state transitions differently for floating views, handle delayed map, ...
...
*** TODO Rounding errors on workspace setup

** TODO Configurable: Set floating windows to chosen size or smallest possible
...
*** TODO Background issues on overlapping outputs
