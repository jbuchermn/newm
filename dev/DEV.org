...
*** TODO Bugs
- [ ] Floating window placement and resizing: example catapult and Firefox Save As
- [ ] Prevent resizing 0, 0 -> 800, 600 -> 734, 453 due to reducer_tiled ignoring padding on size 0
...
- [X] Scaling a window to the left means right border jumps, to the right is ok
- [ ] Do animations block before the compositor even starts? (Really slow startup when anim time is set high)
