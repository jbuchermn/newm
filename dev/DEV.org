...
*** WAIT Bug: obs-studio issues - not reproducible
*** DONE Bug: Occasionally orphan states do appear (last time GIMP-2.99, alacritty -e nmtui without nm running) - newm-cmd clean works, should not be necessary though
*** DONE Bug: Open virtual screen / send mako notification / close virtual screen / send make notification - issues with missing fixed_output
