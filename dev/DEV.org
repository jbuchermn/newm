...
*** TODO Bug: Fullscreen video opens stacked (only in second window)
...
** STRT Update documentation
- [ ] Document new config options
- [X] Document start-newm -d
- [ ] Document functions on layout to be called in keybindings
- [ ] Document and remove any legacy config options
    - wallpaper

- [X] Document newm-cmd open/close-virtual-output - link to newm-sidecar
- [ ] Document panels as deprecated
- [ ] TODO comments
...
** TODO New background
** TODO New video and update changelog
