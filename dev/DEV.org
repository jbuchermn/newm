...
* Current (v0.2)
** Bugs / Technical debt
*** STRT Bug: Occasionally orphan states do appear (last time GIMP-2.99, alacritty -e nmtui without nm running)
...
*** STRT Bug: obs-studio popups if output not placed at 0, 0
