...
* Current (v0.3)
** Improvements
*** STRT Bring down idle CPU - Appears to be related to python gestures
...
** Gestures 
*** DONE C gestures: Incorporate motion and axis
*** DONE C gestures: Properly handle down- and upgrade 3 -> 2, or 4 -> 3, 3 -> 4, ...
*** TODO Configurable to some extent - i.e. enable / disable certain behaviours, exchange 3- / 4- / 5-finger-swipes
*** TODO C gestures: 5 fingers?
