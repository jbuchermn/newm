...
*** WAIT Bug: Flickering issues
*** STRT Bug: obs-studio issues
- [ ] Misplaced popups depending on output position
- [X] Setup obs 2x2, next to it 1x1 windows, scale into 1x1 window -> obs explodes (stops as soon as surface enter output is sent)
- [X] Flicker on resize
*** STRT Every size negotiation with LibreOffice fails

** TODO Pass xdg-decoration info from c and use in _Reducer_floating

** TODO TESTS: Do all tests, find bugs, ...
