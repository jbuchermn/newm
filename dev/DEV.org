...
** Backgrounds
*** TODO Background sshould (if res is sufficient) never be scaled up, no matter how many windows
...
** STRT Interpolation: Trigger size updates on view outside of workspace after anim has finished - this should speed up fullscreen enter-leave animations in situations with lots of windows a bit smoother
