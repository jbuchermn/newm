...
*** DONE Bug: With brave and similar (views that set offset) - focus_border does not play nice
*** DONE Bug: Does not play nice with CSD (floating brave e.g.)
*** DONE Bug: floating - laggy during resize
