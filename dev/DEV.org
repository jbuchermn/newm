...
* Current (v0.2)
** Bugs / Technical debt
*** TODO Bug: Occasiaonally orphan states do appear (last time GIMP-2.99, alacritty -e nmtui without nm running) - at least add them on newm-cmd debug and provide newm-cmd clean
*** DONE Bug: xdg-positioner on layer shell (secondary output and nm-applet)
