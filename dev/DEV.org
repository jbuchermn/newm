...
- [ ] Fix background not blending in and initially scaled wrong
- [ ] Coordinate grids per output (or group of overlapping output) placing all windows on first output
