...
*** STRT Occasional bugs removing rows / cols (possibly related to rounding)
...
*** STRT MoveResizeOverlay: Delayed animation on qutting animation via gesture end (as opposed to Mod release)
