...
*** TODO general panels (transparency possible? )
- [ ] Handle positioning of all panels server-side (so that clients do not need to support transparency)
...
- [X] Create newm-panel-alacritty based on new contract
